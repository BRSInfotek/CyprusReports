...
import org.cyprusbrs.model.MLookupCache;
...
//		if (DB.isConnected(false)) {  // Old code commetted by Mukesh @20230617
	...
	{
		URL url = Cyprus.class.getResource("images/" + fileNameInImageDir);
		if (url == null)
		{
	...
	{
		URL url = Cyprus.class.getResource("images/" + fileName+".gif");
		if (url == null)
			url = Cyprus.class.getResource("images/" + fileName+".png");
		if (url == null)
		{
